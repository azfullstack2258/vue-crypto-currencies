...
export const fetchPopularCurrencies = async () => {
  return axiosInstance.get(`${COINMARKETCAP_API_URL}/v1/cryptocurrency/listings/latest`, {
    headers: {
...
export const fetchCurrencyHistorical = async (symbol: string) => {
  return axiosInstance.get(`${MIN_API_CRYPTOCOMPARE_API_URL}/data/blockchain/histo/day?fsym=${symbol}`, {
    headers: {
